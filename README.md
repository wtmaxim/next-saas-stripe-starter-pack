...
<p align="center">
  <a href="https://twitter.com/wtAngat">
    <img src="https://img.shields.io/twitter/follow/wtAngat?style=flat&label=wtAngat&logo=twitter&color=0bf&logoColor=fff" alt="wtAngat Twitter follower count" />
  </a>
</p>
...
```bash
npx create-next-app my-saas-project --example "https://github.com/wtmaxim/next-stripe-starter-pack"
```
